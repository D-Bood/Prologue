...
&copy; 2013-<?php echo date('Y'); ?> <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title() ?></a> with <a href="http://www.typecho.org" target="_blank">Typecho</a><br>Original Design: <a href="https://html5up.net/prologue" target="_blank">HTML5 UP</a> <?php if($this->user->hasLogin()): ?> Your IP: <?php echo $_SERVER["REMOTE_ADDR"]; ?><?php endif ?><br><?php hitokoto() ?>
</div>
   </div>
