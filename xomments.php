    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
        ...
        <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
          <div class="row">
            ...
            <p class="userstatus" style="padding-top: 2em"><?php _e('已登入: '); ?><a href="<?php $this->options->profileUrl(); ?>"><?php $this->user->screenName(); ?></a>. <a href="<?php $this->options->logoutUrl(); ?>" title="Logout"><?php _e('退出'); ?> &raquo;</a></p>
            <?php else: ?>
                <?php if($this->remember('author',true) != "" && $this->remember('mail',true) != "") : ?> 
                
                    <span onClick='showhidediv("author_info")'; style="cursor:pointer;color:#2479cc;"><?php $this->remember('author'); ?>，<?php _e('欢迎回来'); ?></span>
            ...
            <input type="text" name="author" placeholder="<?php _e('称呼 *'); ?>" value="<?php $this->remember('author'); ?>"></div>
    		<div class="6u$ 12u$(mobile)">
            <input type="email" name="mail" placeholder="<?php _e('电子邮箱 *'); ?>" value="<?php $this->remember('mail'); ?>"></div>
    		<div class="6u 12u$(mobile)">
            <input type="url" name="url" placeholder="<?php _e('网址(http://)'); ?>" value="<?php $this->remember('url'); ?>"></div>
    		<div class="6u$ 12u$(mobile)">
            <?php reCAPTCHA_Plugin::output(); ?></div>
               </div>
               <?php endif; ?>
            <div class="12u$">
...
if(sbtitle){  
   ...
   sbtitle.style.width='100%';
   sbtitle.style.padding='0';
   }  
}  
}
